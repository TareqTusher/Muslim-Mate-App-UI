  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return SizedBox(
      ...
      child: Stack(
        children: [
          Positioned.fill(
            child: Image.asset("assets/images/ramadan4.png", fit: BoxFit.fill),
          ),
                      ...
                      children: [
                        Text(
                          provider.selectedTime != null
                              ? "${provider.selectedTime!.hourOfPeriod == 0 ? 24 : provider.selectedTime!.hourOfPeriod}:${provider.selectedTime!.minute.toString().padLeft(2, "0")} ${provider.selectedTime!.period == DayPeriod.am ? "AM" : "PM"}"
                              : "14:01",
