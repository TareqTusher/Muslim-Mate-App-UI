...
class TextStyles {
  ...
  static  TextStyle fontText14Medium (Color color){
 ...
 static  TextStyle fontText16Regular (Color color){
  return GoogleFonts.poppins(color: color,fontWeight: FontWeight.w400,fontSize: 16);

}
 static  TextStyle fontText20Medium (Color color){
